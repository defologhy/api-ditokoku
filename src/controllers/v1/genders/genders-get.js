...
const gendersGet = async(request, response) =>{
    /*
    ...
    */
    ...
    try{
        ...
        //5 - Pengambilan total record
        const queryCount = "select count(genders.id) record_counts\n" +
        ...
        //6 - Ambil data dari database
        const query = "select genders.id gender_id, genders.name gender_name \n" +
        ...
        const genders = await ditokokuSequelize.query(query,{ type: QueryTypes.SELECT });
